  ...
  return (
    <div class = "solid border-b border-zinc-700 flex  flex-none flex-col items-center flex-none justify-center h-44" >
      ...
      <div class = "mt-8 flex items-center justify-center flex-row">
        <input class="rounded-sm" id = 'guessInput' disabled={!activeGame} onKeyDown={(e) => {checkForSubmit(e)}} onChange ={(e) => handleInputChange(e)} class="mr-1 px-1 py-1 focus:outline-none disabled:opacity-10 p-0 mdt-auto mdb-4" ></input>
